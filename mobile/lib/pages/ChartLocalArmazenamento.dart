...
import 'package:inventory_analytics/model/indicator.dart';
        ...
        child: Row(
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Indicator(color: Color(0xff0293ee), text: "LC 922", isSquare: true,),
                SizedBox(
                  height: 4,
                ),
                Indicator(color: Color(0xfff8b250), text: "LC 22", isSquare: true,),
                SizedBox(
                  height: 4,
                ),
                Indicator(color: Color(0xff845bef), text: "LC 100", isSquare: true,),
                SizedBox(
                  height: 4,
                ),
                Indicator(color: Color(0xff13d38e), text: "LC 678", isSquare: true,),
                SizedBox(
                  height: 18,
                ),
              ],
